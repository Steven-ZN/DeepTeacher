...
# DeepTeacher
一个基于 DeepSeek-Vision R1 14B模型的本地部署学习辅导系统，结合实时截屏、图像理解、语言反馈的沉浸式交互学习助手。
A locally deployed learning assistance system based on the DeepSeek-Vision R1 14B model, integrating real-time screenshots, image understanding, and language feedback for an immersive interactive learning assistant.
